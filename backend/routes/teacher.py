...
def get_students(institution_id: str) -> List[Dict[str, Any]]:
...
def assign_program(req: AssignProgramRequest):
...
def approve_student(req: ApproveStudentRequest):
    """Öğrenci onaylama."""
...
def get_classes_route(institution_id: str) -> List[Dict[str, Any]]:
    """Sınıfları listeleme."""
...
def assign_class(req: AssignClassRequest):
