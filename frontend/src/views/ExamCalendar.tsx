...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, ScrollView, StatusBar, Alert, Modal, Platform, Dimensions } from 'react-native';
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                >
                    ...
                    <View style={s.headerRow}>
                        ...
                        <View style={s.headerBadge}>
                            <Text style={s.headerBadgeText}>{upcoming.length}</Text>
                        </View>
                    </View>
                </LinearGradient>
                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={s.sectionHeader}>
                        ...
                        <Text style={[s.sectionTitle, { color: theme.text }]}>Gelecek Sınavlar</Text>
