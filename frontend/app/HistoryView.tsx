...
export const HistoryView = ({ theme, onBack, userId }: any) => {
  ...
  // Haftalık toplam soru sayısını hesapla
              ...
              >
                <View style={styles.cardHeader}>
                  <View>
                    ...
                    <Text style={[styles.weekTitle, { color: theme.text }]}>Haftalık Analiz</Text>
                  </View>
          ...
          <View style={[styles.modalContent, { backgroundColor: theme.surface }]}>
            <View style={styles.modalHeader}>
              <View>
                ...
                <Text style={{color: theme.textSecondary, fontSize: 12}}>Çözülen sorular ders bazlı listelenmiştir.</Text>
              </View>
